...
- Patterns/Practices, the model definition closely resembles Angular's ngResource meaning its easy to swap out, replace later (if ngResource gets awesome next release * hint hint angular team *), eases scaling new devs / organizations, and its designed for Angular; not a backbone port!
